...
#計算
Drop_of_artifacts = random.randint(0,10 )  # 聖遺物ドロップ数を1から2の間でランダムに決定
if Drop_of_artifacts < 65:
    Drop_of_artifacts = 1  # 65%の確率で1個ドロップ
else:
    Drop_of_artifacts = 2  # 35%の確率で2個ドロップ

if Drop_of_artifacts == 2:
    artifact_2_type = random.randint(0, 4)  # 0=花 1=羽 2=時計 3=杯 4=冠
    if artifact_2_type == 0:
        artifact_2_main = 3;  # HP実数 
        artifact_2_main_value = 717
    elif artifact_2_type == 1:
        artifact_2_main = 0;  # 攻撃実数
        artifact_2_main_value = 47
    elif artifact_2_type == 2:
        artifact_2_main = random.randint(1,1000)
        if 1<= artifact_2_main <= 267:
            artifact_2_main = 7; # HP%
            artifact_2_main_value = 7.0
        elif 267< artifact_2_main <= 534:
            artifact_2_main = 8; # 攻撃％
            artifact_2_main_value = 7.0
        elif 534 < artifact_2_main <= 801:
            artifact_2_main = 9; # 防御％
            artifact_2_main_value = 8.7
        elif 801 < artifact_2_main <= 901:
            artifact_2_main = 2; # 熟知
            artifact_2_main_value = 28
        elif 901< artifact_2_main <= 1000:
            artifact_2_main = 6; # 元素チャージ効率
            artifact_2_main_value = 7.8
    elif artifact_2_type == 3:
        artifact_2_main = random.randint(1,1000)
        if 1 <= artifact_2_main <= 191:
            artifact_2_main = 7; # HP%
            artifact_2_main_value = 7.0
        elif 191 < artifact_2_main <= 383:
            artifact_2_main = 8; # 攻撃％
            artifact_2_main_value = 7.0
        elif 383 < artifact_2_main <= 575:
            artifact_2_main = 9; # 防御％
            artifact_2_main_value = 8.7
        elif 575 < artifact_2_main <= 600:
            artifact_2_main = 2; # 熟知
            artifact_2_main_value = 28
        elif 600 < artifact_2_main <= 650:
            artifact_2_main = 10; # 風元素ダメージ
            artifact_2_main_value = 7.0
        elif 650 < artifact_2_main <= 700:
            artifact_2_main = 11; # 岩元素ダメージ
            artifact_2_main_value = 7.0
        elif 700 < artifact_2_main <= 750:
            artifact_2_main = 12; # 雷元素ダメージ
            artifact_2_main_value = 7.0
        elif 750 < artifact_2_main <= 800:
            artifact_2_main = 13; # 草元素ダメージ
            artifact_2_main_value = 7.0
        elif 800 < artifact_2_main <= 850:
            artifact_2_main = 14; # 水元素ダメージ
            artifact_2_main_value = 7.0 
        elif 850 < artifact_2_main <= 900:
            artifact_2_main = 15; # 炎元素ダメージ
            artifact_2_main_value = 7.0
        elif 900 < artifact_2_main <= 950:
            artifact_2_main = 16; # 氷元素ダメージ
            artifact_2_main_value = 7.0
        elif 950 < artifact_2_main <= 1000:
            artifact_2_main = 17; # 物理ダメージ
            artifact_2_main_value = 7.0
    elif artifact_2_type == 4:
        artifact_2_main = random.randint(1,100)
        if 1 <= artifact_2_main <= 22:
            artifact_2_main = 8; # 攻撃％
            artifact_2_main_value = 7.0
        elif 22 < artifact_2_main <= 44:
            artifact_2_main = 9; # 防御％
            artifact_2_main_value = 8.7
        elif 44 < artifact_2_main <= 66:
            artifact_2_main = 7; # HP%
            artifact_2_main_value = 7.0
        elif 66 < artifact_2_main <= 70:
            artifact_2_main = 2; # 熟知
            artifact_2_main_value = 28
        elif 70 < artifact_2_main <= 80:
            artifact_2_main = 4; # 会心率
            artifact_2_main_value = 9.3
        elif 80 < artifact_2_main <= 90:
            artifact_2_main = 5; # 会心ダメージ
            artifact_2_main_value = 18.6
        elif 90 < artifact_2_main <= 100:
            artifact_2_main = 18; # 与える治療効果
            artifact_2_main_value = 5.8
        artifact_2_sub = random.randint(3, 4)  # サブステータス数(3または4)
        if artifact_2_sub == 3:
            artifact_2_sub_1 = random.randint(0, 9)  # サブステータス1の種類
            while artifact_2_sub_1 == artifact_2_main: # メインステータスと同じサブステータスは出ない
                artifact_2_sub_1 = random.randint(0, 9)
            if artifact_2_sub_1 == 0:
                artifact_2_sub_1_value = random.choice([14, 16, 18, 19])  # 攻撃実数
            elif artifact_2_sub_1 == 1:
                artifact_2_sub_1_value = random.choice([16, 19, 21, 23]) # 防御実数
            elif artifact_2_sub_1 == 2:
                artifact_2_sub_1_value = random.choice([16, 19, 21, 23]) # 熟知
            elif artifact_2_sub_1 == 3:
                artifact_2_sub_1_value = random.choice([209, 239, 269, 299])  # HP実数
            elif artifact_2_sub_1 == 4:
                artifact_2_sub_1_value = random.choice([2.7, 3.1, 3.5, 3.9])  # 会心率
            elif artifact_2_sub_1 == 5:
                artifact_2_sub_1_value = random.choice([5.4, 6.2, 7.0, 7.8]) # 会心ダメージ
            elif artifact_2_sub_1 == 6:
                artifact_2_sub_1_value = random.choice([4.5, 5.2, 5.8, 6.5]) # 元素チャージ効率
            elif artifact_2_sub_1 == 7:
                artifact_2_sub_1_value = random.choice([4.1, 4.7, 5.3, 5.8])  # HP%
            elif artifact_2_sub_1 == 8:
                artifact_2_sub_1_value = random.choice([4.1, 4.7, 5.3, 5.8]) # 攻撃％
            elif artifact_2_sub_1 == 9:
                artifact_2_sub_1_value = random.choice([5.1, 5.8, 6.6, 7.3])  # 防御％

            artifact_2_sub_2 = random.randint(0, 9)  # サブステータス2の種類
            while artifact_2_sub_2 == artifact_2_main or artifact_2_sub_2 == artifact_2_sub_1: # 既に出たステータスと同じサブステータスは出ない
                artifact_2_sub_2 = random.randint(0, 9)
            if artifact_2_sub_2 == 0:
                artifact_2_sub_2_value = random.choice([14, 16, 18, 19])  # 攻撃実数
            elif artifact_2_sub_2 == 1:
                artifact_2_sub_2_value = random.choice([16, 19, 21, 23]) # 防御実数
            elif artifact_2_sub_2 == 2:
                artifact_2_sub_2_value = random.choice([16, 19, 21, 23]) # 熟知
            elif artifact_2_sub_2 == 3:
                artifact_2_sub_2_value = random.choice([209, 239, 269, 299])  # HP実数
            elif artifact_2_sub_2 == 4:
                artifact_2_sub_2_value = random.choice([2.7, 3.1, 3.5, 3.9])  # 会心率
            elif artifact_2_sub_2 == 5:
                artifact_2_sub_2_value = random.choice([5.4, 6.2, 7.0, 7.8]) # 会心ダメージ
            elif artifact_2_sub_2 == 6:
                artifact_2_sub_2_value = random.choice([4.5, 5.2, 5.8, 6.5]) # 元素チャージ効率
            elif artifact_2_sub_2 == 7:
                artifact_2_sub_2_value = random.choice([4.1, 4.7, 5.3, 5.8])  # HP%
            elif artifact_2_sub_2 == 8:
                artifact_2_sub_2_value = random.choice([4.1, 4.7, 5.3, 5.8]) # 攻撃％
            elif artifact_2_sub_2 == 9:
                artifact_2_sub_2_value = random.choice([5.1, 5.8, 6.6, 7.3])  # 防御％

            artifact_2_sub_3 = random.randint(0, 9)  # サブステータス3の種類
            while artifact_2_sub_3 == artifact_2_main or artifact_2_sub_3 == artifact_2_sub_1 or artifact_2_sub_3   == artifact_2_sub_2: # 既に出たステータスと同じサブステータスは出ない
                artifact_2_sub_3 = random.randint(0, 9)
            if artifact_2_sub_3 == 0:
                artifact_2_sub_3_value = random.choice([14, 16, 18, 19])  # 攻撃実数
            elif artifact_2_sub_3 == 1:
                artifact_2_sub_3_value = random.choice([16, 19, 21, 23]) # 防御実数
            elif artifact_2_sub_3 == 2:
                artifact_2_sub_3_value = random.choice([16, 19, 21, 23]) # 熟知
            elif artifact_2_sub_3 == 3:
                artifact_2_sub_3_value = random.choice([209, 239, 269, 299])  # HP実数
            elif artifact_2_sub_3 == 4:
                artifact_2_sub_3_value = random.choice([2.7, 3.1, 3.5, 3.9])  # 会心率
            elif artifact_2_sub_3 == 5:
                artifact_2_sub_3_value = random.choice([5.4, 6.2, 7.0, 7.8]) # 会心ダメージ
            elif artifact_2_sub_3 == 6:
                artifact_2_sub_3_value = random.choice([4.5, 5.2, 5.8, 6.5]) # 元素チャージ効率
            elif artifact_2_sub_3 == 7:
                artifact_2_sub_3_value = random.choice([4.1, 4.7, 5.3, 5.8])  # HP%
            elif artifact_2_sub_3 == 8:
                artifact_2_sub_3_value = random.choice([4.1, 4.7, 5.3, 5.8]) # 攻撃％
            elif artifact_2_sub_3 == 9:
                artifact_2_sub_3_value = random.choice([5.1, 5.8, 6.6, 7.3])  # 防御％

        elif artifact_2_sub == 4:
            artifact_2_sub_1 = random.randint(0, 9)  # サブステータス1の種類
            while artifact_2_sub_1 == artifact_2_main: # メインステータスと同じサブステータスは出ない
                artifact_2_sub_1 = random.randint(0, 9)
            if artifact_2_sub_1 == 0:
            ...
            artifact_2_sub_2 = random.randint(0, 9)  # サブステータス2の種類
            while artifact_2_sub_2 == artifact_2_main or artifact_2_sub_2 == artifact_2_sub_1: # 既に出たステータスと同 じサブステータスは出ない
                artifact_2_sub_2 = random.randint(0, 9)
            if artifact_2_sub_2 == 0:
                artifact_2_sub_2_value = random.choice([14, 16, 18, 19])  # 攻撃実数
            elif artifact_2_sub_2 == 1:
            ...
            if artifact_2_sub_3 == 0:
                ...
                artifact_2_sub_3_value = random.choice([5.1, 5.8, 6.6, 7.3])  # 防御％
            artifact_2_sub_4 = random.randint(0, 9)  # サブステータス4の種類
            while artifact_2_sub_4 == artifact_2_main or artifact_2_sub_4 == artifact_2_sub_1 or artifact_2_sub_4   == artifact_2_sub_2 or artifact_2_sub_4 == artifact_2_sub_3: # 既に出たステータスと同じサブステータスは   出ない
                artifact_2_sub_4 = random.randint(0, 9)
            if artifact_2_sub_4 == 0:
                artifact_2_sub_4_value = random.choice([14, 16, 18, 19])  # 攻撃実数
            elif artifact_2_sub_4 == 1:
                artifact_2_sub_4_value = random.choice([16, 19, 21, 23]) # 防御実数
            elif artifact_2_sub_4 == 2:
                artifact_2_sub_4_value = random.choice([16, 19, 21, 23]) # 熟知
            elif artifact_2_sub_4 == 3:
                artifact_2_sub_4_value = random.choice([209, 239, 269, 299])  # HP実数
            elif artifact_2_sub_4 == 4:
                artifact_2_sub_4_value = random.choice([2.7, 3.1, 3.5, 3.9])  # 会心率
            elif artifact_2_sub_4 == 5:
                artifact_2_sub_4_value = random.choice([5.4, 6.2, 7.0, 7.8]) # 会心ダメージ
            elif artifact_2_sub_4 == 6:
                artifact_2_sub_4_value = random.choice([4.5, 5.2, 5.8, 6.5]) # 元素チャージ効率
            elif artifact_2_sub_4 == 7:
                artifact_2_sub_4_value = random.choice([4.1, 4.7, 5.3, 5.8])  # HP%
            elif artifact_2_sub_4 == 8:
                artifact_2_sub_4_value = random.choice([4.1, 4.7, 5.3, 5.8]) # 攻撃％
            elif artifact_2_sub_4 == 9:
                artifact_2_sub_4_value = random.choice([5.1, 5.8, 6.6, 7.3])  # 防御％
